...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?> navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            <?php if ($logo): ?>
                <h1 id="h1-logo"><a class="logo navbar-btn pull-left" href="<?php print $front_page; ?>"
                                    title="<?php print t('Home'); ?>">
                        <img src="<?php print $logo; ?>"
                             alt="Eliis - Software Solutions in Seismic Interpretation - <?php print t('Home'); ?>"/>
                    </a></h1>
            <?php endif; ?>
...
<footer class="footer container">
    ...
    <div id="footer-adress">
        <div id="adress-eliis"><img src="/sites/all/themes/eliis/images/logo-eliis-small-no-text.png" alt="logo Eliis"
                                    style="vertical-align:middle;"> Eliis - 3, rue Jean Monnet – 34 830 Clapiers – France - France | <a href="mailto:contact@eliis.fr">contact@eliis.fr</a> | Tel :
            +33(0) 4 67 41 31 16
        </div>
